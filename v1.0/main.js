...
import { BattleSystem } from './systems/BattleSystem.js?v=release-20260611-7';
...
import { DropSystem } from './systems/DropSystem.js?v=release-20260611-7';
...
import { Player } from './entities/Player.js?v=release-20260611-7';
...
import { runCharacterCreationFlow, getBaseCareers } from './flows/character_creation_flow.js?v=release-20260611-7';
import { getDeletionConfirmInfo, executeDeletion, hasAnyCharacter } from './flows/character_deletion_flow.js?v=release-20260611-7';
import { exportSave as doExportSave, importSave } from './flows/save_transfer.js';
import { AutoPlaySystem } from './systems/AutoPlaySystem.js?v=release-20260611-7';
import { TeleportSystem } from './systems/TeleportSystem.js?v=release-20260611-7';
import { OfflineSimulator } from './systems/OfflineSimulator.js?v=release-20260611-7';
import { storage } from './utils/storage.js';
import { restoreRuntimePlayerFromSave } from './utils/player_restore.js?v=release-20260611-7';
import { UIManager } from './ui/UIManager.js?v=release-20260611-7';
import { buildMainScreenUI } from './ui/MainScreenUI.js?v=release-20260611-7';
import { buildMapList, switchToZoneView, switchToTownView } from './ui/MapListPanelUI.js?v=release-20260611-7';
import { openTownNPCDialog, showNPCDialog } from './ui/NPCDialogUI.js?v=release-20260611-7';
import {
...
} from './ui/MultiSaveUI.js?v=release-20260611-7';
import './ui/BottomBarUI.js?v=release-20260611-7';

// ========================
// 数据加载
// ========================
const DATA_VERSION = 'release-20260611-7';
